...
7. If you are running the `support-desk` example, the workspace starts with paginated seeded tickets and live chats for the customer and admin views. Create a new ticket in the customer inbox, then switch to the admin console to work the same issue from the shared fake database.
